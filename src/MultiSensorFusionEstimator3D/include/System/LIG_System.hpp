 ...
 * @Description:  激光 & IMU & GNSS 融合SLAM系统
 * @Others: 
 */
...
namespace {
    ...
    class LidarImuGnssFusionSystem
    {
        public:
        ...
        public:
                  ...
                  NUM_OF_LIDAR_(NUM_OF_LIDAR)
            {
                ...
                // 启动估计线程
                estimate_thread_ = std::thread(&LidarImuGnssFusionSystem::processMeasurements, this); 
                // 设置数据库保存路径
             ...
             * @return {*}
             */    
            void Process(ImuDataConstPtr const& data)
            {}
             ...
             * @return {*}
             */                
            void Process(GnssDataConstPtr const& data) 
            {}
...
/**
 * @todo 在这里实现工厂函数  CreateLidarImuGnssSystem()
 */
}// namespace 

 ...
 * @Others: 
 */
#ifndef KKL_G2O_EDGE_SE3_PRIORROT_HPP
#define KKL_G2O_EDGE_SE3_PRIORROT_HPP
...
class EdgeSE3PriorRot : public g2o::BaseUnaryEdge<3, Eigen::Quaterniond, g2o::VertexSE3> 
{
	public:

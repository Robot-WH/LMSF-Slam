...
public:
    ...
    */
    mapOptimization()
    {
        ...
        subCloud = nh.subscribe<liv_slam::cloud_info>("lio_sam/feature/cloud_info", 1, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
        // 订阅GPS里程计
    ...
    */
    ...
    //  * 保存全局关键帧特征点集合
    // */
    // bool saveMapService(liv_slam::save_mapRequest& req, liv_slam::save_mapResponse& res)
    // {

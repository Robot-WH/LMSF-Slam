...
const bool useXYZIRTclouds = false;  
...
private:
    ...
    // 激光处理
    std::unique_ptr<LidarScanProcessing> scan_processing;   
...
public:
    ...
    */
    ...
    deskewFlag(0)
    {
        ...
        // 发布当前激光帧运动畸变校正后的点云信息
        pubLaserCloudInfo = nh.advertise<liv_slam::cloud_info> ("lio_sam/deskew/cloud_info", 1);
    ...
    */
    ...
    {   
        ...
        scan_processing.reset(new LidarScanProcessing());  
    ...
    */
    void cloudHandler(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        // 需要计算线束模型   
        #if useXYZIRTclouds==false
           scan_processing->FindStartEndAngle(laserCloudIn, cloudInfo.startOrientation, cloudInfo.endOrientation);
           scan_processing->CalculateLidarModel(laserCloudIn, N_SCAN, 
                             cloudInfo.startOrientation, cloudInfo.endOrientation);
        #endif
    ...
    */
    bool cachePointCloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        // 取出激光点云队列中最早的一帧
        currentCloudMsg = std::move(cloudQueue.front());   // 转换为右值   调用移动赋值函数  
    ...
    */
    void projectPointCloud()
    {
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            #else
                int rowIdn = int(laserCloudIn->points[i].intensity);
            #endif
...
int main(int argc, char** argv)
{
    ...
    ROS_INFO("\033[1;32m----> noted Image Projection Started.\033[0m");

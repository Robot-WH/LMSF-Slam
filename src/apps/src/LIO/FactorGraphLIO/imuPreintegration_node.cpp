...
public:
    ...
    */
    IMUPreintegration()
    {
        ...
        p->gyroscopeCovariance      = gtsam::Matrix33::Identity(3,3) * pow(imuGyroNoise, 2); // gyro white noise in continuous
        ...
        noiseModelBetweenBias = (gtsam::Vector(6) << imuAccBiasN, imuAccBiasN, imuAccBiasN, imuGyroBiasN, imuGyroBiasN, imuGyroBiasN).finished();
